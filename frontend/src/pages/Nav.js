  ...
  return (
    <>
      <nav className='fixed bg-white shadow shadow-slate-100 z-20 w-full h-16 flex flex-row items-center justify-around x-sm:justify-between x-sm:pb-1 x-sm:pt-0.5 x-sm:flex-col x-sm:gap-1 x-sm:h-fit'>
          <div className="">
              <a href="/" className='font-semibold capitalize text-2xl'>exclusive</a>
          </div>
          <div className="w-fit flex flex-row gap-6 capitalize font-medium tablet:hidden x-sm:hidden">
              <Link to={'/'} children='home' className='focus:underline hover:underline hover:underline-offset-4'/>
              <Link to={'/contact'} children='contact' className='focus:underline hover:underline hover:underline-offset-4'/>
              <Link to={'/about'} children='about' className='focus:underline hover:underline hover:underline-offset-4'/>
              <Link to={'/sign up'} children='sign up' className='focus:underline hover:underline hover:underline-offset-4'/>
              <Link to={'/sign in'} children='sign in' className='focus:underline hover:underline hover:underline-offset-4'/>
          </div>
